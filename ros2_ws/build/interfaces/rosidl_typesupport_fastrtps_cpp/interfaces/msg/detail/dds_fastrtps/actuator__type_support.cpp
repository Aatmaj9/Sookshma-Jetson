...
#include "interfaces/msg/detail/actuator__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.actuator_names;
  }
  // Member: covariance
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: actuator_names
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.actuator_names[index].size() + 1);
    }
  }
  // Member: covariance
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Actuator;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Actuator *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Actuator *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Actuator__handle;
}

...
class Actuator(metaclass=Metaclass_Actuator):
    ...
    _fields_and_field_types = {
        ...
        'actuator_values': 'sequence<double>',
        'actuator_names': 'sequence<string>',
    ...
    def __init__(self, **kwargs):
        ...
        self.actuator_values = array.array('d', kwargs.get('actuator_values', []))
        self.actuator_names = kwargs.get('actuator_names', [])
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.actuator_values != other.actuator_values:
            return False
        if self.actuator_names != other.actuator_names:
            return False
    ...
    def actuator_values(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'actuator_values' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'actuator_values' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._actuator_values = array.array('d', value)

    @builtins.property
    def actuator_names(self):
        """Message field 'actuator_names'."""
        return self._actuator_names

    @actuator_names.setter
    def actuator_names(self, value):
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'actuator_names' field must be a set or sequence and each value of type 'str'"
